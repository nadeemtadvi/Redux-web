...
function reducer(state = initialState, action) {
    switch(action.type){
        ...
        case CART_REMOVE_ITEM:
            return {
                ...state,
                cardItems: state.cardItems.filter((item)=>item.productId !== action.payload.productId)
            };
...
},{"redux":"anWnS","./productList":"dCC0l"}],"anWnS":[function(require,module,exports,__globalThis) {
