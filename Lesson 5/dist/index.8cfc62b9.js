...
const reducer = (0, _redux.combineReducers)({
    ...
    cardItems: (0, _cartReducerDefault.default),
    wishLists: (0, _wishlistReducerDefault.default)
});
const store = (0, _redux.createStore)(reducer, window.__REDUX_DEVTOOLS_EXTENSION__?.());
console.log(store);
store.dispatch((0, _cartReducer.cartAddItem)(1));
store.dispatch((0, _cartReducer.cartAddItem)(2));
store.dispatch((0, _cartReducer.cartAddItem)(3));
store.dispatch((0, _cartReducer.cartAddItem)(4));
store.dispatch((0, _cartReducer.cartRemoveItem)(4));
store.dispatch((0, _cartReducer.cartaddItemQuantity)(2));
store.dispatch((0, _cartReducer.cartaddItemQuantity)(2));
store.dispatch((0, _cartReducer.cartRemoveItemQuantity)(2));
store.dispatch((0, _cartReducer.cartRemoveItemQuantity)(2));
store.dispatch((0, _cartReducer.cartRemoveItemQuantity)(2));
store.dispatch((0, _wishlistReducer.wishlistAddItem)(3));
store.dispatch((0, _wishlistReducer.wishlistAddItem)(4));
store.dispatch((0, _wishlistReducer.wishlistRemoveItem)(4));

},{"redux":"anWnS","./cartReducer":"96Hwp","./productReducer":"g20cL","./wishlistReducer":"77x5m","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"anWnS":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "cartRemoveItemQuantity", ()=>cartRemoveItemQuantity);
parcelHelpers.export(exports, "cartaddItemQuantity", ()=>cartaddItemQuantity);
...
function cartRemoveItemQuantity(productId) {
    return {
...
function cartaddItemQuantity(productId) {
    return {
...
function productReducer(state = (0, _productList.productList)) {
    return state;
}

},{"./productList":"dCC0l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dCC0l":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"77x5m":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
