...
const Cartitem = ({ productId, title, rating, price, imageUrl, quantity }) => {
  ...
  return (
    <div className="cart-item-container p-4 border-b border-gray-300 grid grid-cols-[40%_auto_auto_auto] lg:grid-cols-4 gap-4">
      ...
      <div className="item-price flex items-center justify-center text-lg font-medium">
        ${price}
      </div>
      ...
      <div className="item-total flex items-center justify-end text-lg font-medium">
        ${quantity * price}
      </div>
    </div>
  );
